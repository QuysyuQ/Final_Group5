...
namespace DAL.Migrations
{
    ...
    [Migration("20250117012917_addColumPayToMoneyToTableOrder")]
    partial class addColumPayToMoneyToTableOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Order", b =>
                {
                    b.HasOne("DAL.Models.PayToMoney", "PayToMoney")
                        .WithMany()
                        .HasForeignKey("PayToMoneyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
